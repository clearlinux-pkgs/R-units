...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/units_0.8-7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742480768
...
/usr/lib64/R/library/units/tests/testthat/_snaps/plot/ggplot2-limits-other-units.svg
/usr/lib64/R/library/units/tests/testthat/_snaps/plot/ggplot2-limits-via-scale-with-units.svg
/usr/lib64/R/library/units/tests/testthat/_snaps/plot/ggplot2-limits-via-scale.svg
/usr/lib64/R/library/units/tests/testthat/_snaps/plot/ggplot2-limits-via-xlim.svg
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/units/libs/units.so
/V4/usr/lib64/R/library/units/libs/units.so
